...
<section>
    <div class="mx-auto md:max-w-6xl px-4 xl:px-0 py-16">
        ...
        <div class="w-full bg-gray-200 rounded-sm shadow-xs p-8 my-8">
            <div>
                <label class="block text-gray-700 text-sm font-bold mb-2" for="email">
                    <?= __('Your email') ?>
                </label>
                <input class="shadow-sm appearance-none border rounded-sm w-full py-2 px-3 text-gray-700 leading-tight focus:outline-hidden focus:shadow-outline"
                       name="email" id="email" type="email" placeholder="yourname@example.org" required>
            </div>
            <div class="my-8">
                <form class="" id="bank-form" method="get">
                    <button class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-sm focus:outline-hidden focus:shadow-outline"
